...
%
% Usage: 
%   Main code for FIND THE BRIGHTEST REGION
%
% Purpose: 
...
%% ------(a)--------------------------------------------------------------%
%  For image f with size M*N, choose a threshold 188 so that turn the  
%  pixels gray-level above 188 into one otherwise into zero.
...
%  Display the labeled image with colored components using "label2rgb"

[flabel,sum] = bwlabel(fthresh,8);  %  8-connected objects
